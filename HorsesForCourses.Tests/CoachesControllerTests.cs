...
public class CoachesControllerTests
{
  ...
  [Fact]
  public void CreateCoach_ReturnsProblem_WhenDtoIsNull()
  {
      var result = _controller.CreateCoach(null!) as ObjectResult;
      Assert.NotNull(result);
      Assert.Equal(500, result!.StatusCode);
  }

  [Fact]
  public void UpdateSkills_ReturnsProblem_WhenCoachNotFound()
  {
      var dto = new UpdateCoachSkillsDto { Skills = new List<string> { "X" } };
  ...
  [Fact]
  public void GetById_ReturnsProblem_WhenCoachNotFound()
  {
